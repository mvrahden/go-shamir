...
//
// This file is vendored from github.com/hashicorp/vault/shamir at v1.17.3
// and remains under the Mozilla Public License 2.0; see LICENSE, which is
// HashiCorp's own licence file from that same directory. MPL-2.0 is
// file-level copyleft: this file stays MPL, the rest of this module does
// not become MPL by including it.
//
// Vendored rather than imported because reaching this one stdlib-only file
// through the module graph would require depending on the whole
// github.com/hashicorp/vault module, whose top-level LICENSE is BUSL-1.1
// and whose dependency graph is enormous.
//
// MODIFICATIONS from upstream:
//   - none to the algorithm. Only this header.
